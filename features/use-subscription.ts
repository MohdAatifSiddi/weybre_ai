...
type RequestUpgradeSubscriptionType = InferRequestType<typeof api.subscription.upgrade.$post>["json"];
type ResponseUpgradeSubscriptionType = InferResponseType<typeof api.subscription.upgrade.$post>;
