...
import { AlertCircle, AlertCircleIcon, CircleSlash, FileText, GlobeIcon, Icon, icons, Lightbulb, SearchIcon } from "lucide-react";

export const getToolStatus = (
    toolName: string, state: ToolUIPart["state"],
    output?: any
) => {
