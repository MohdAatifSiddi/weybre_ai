...
const ChatInterface = (props: Props) => {
    ...
    const hasReachedLimit = !!subscription && subscription.generationsLimit !== null && subscription.generationsUsed >= subscription.generationsLimit;
...
function GenerationLimitAlert() {
    return (
        <div className="w-full absolute -top-6 mt-[0.3rem]">
            <div className="bg-primary/10 font-medium rounded-t-3xl px-4 pt-1.5 pb-4 flex items-center justify-between text-xs w-full overflow-hidden">
