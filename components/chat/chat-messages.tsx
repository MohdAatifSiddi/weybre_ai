    ...
    return (
        <div ref={scrollRef} className="overflow-y-auto h-auto">
            <Conversation className="h-auto min-h-[calc(100vh-157px)]">
                <ConversationContent className="w-full h-auto !pb-40 pt-15 flex flex-col gap-5 lg:px-0 md:max-w-3xl mx-auto">
                    {isLoading && <LoadingMessage />}
                    {!isLoading && messages.length === 0 && <Greating />}
    ...
    return (
        <div className="w-full max-w-full mx-auto mt-5">
            <div className="flex  items-start space-x-3">
                ...
                <div className="w-fll flex flex-col space-y-2">
