            ...
            <div className={cn("w-full", !isChatView && "max-w-2xl mx-auto space-y-5 px-4 md:px-0")}>
                {!isChatView && (
                    <div className="w-full flex items-center justify-center mt-16">
                        <h1 className="flex items-center gap-2 font-semibold text-pretty text-center tracking-tighter text-gray-800 dark:text-whote sm:text-[30px] md:text-[35px] text-[24px] opacity-0 fade-in-up [animation-delay: 200ms] z-0">
